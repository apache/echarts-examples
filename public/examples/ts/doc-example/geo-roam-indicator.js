...
function updateIndicators() {
    ...
    var indicatorRects = app.__internalAPI.retrieveViewCoordSysRects(myChart, {mainType: 'geo', id: 'my_geo'});
...
function initFloatingControlPanelAndContext() {
    ...
    app.configParameters.preserveAspect = {options: [true, false, 'contain', 'cover']};
    app.config.preserveAspectAlign = 'center';
    app.configParameters.preserveAspectAlign = {options: ['center', 'left', 'right']};
    app.config.preserveAspectVerticalAlign = 'middle';
    app.configParameters.preserveAspectVerticalAlign = {options: ['middle', 'top', 'bottom']};
